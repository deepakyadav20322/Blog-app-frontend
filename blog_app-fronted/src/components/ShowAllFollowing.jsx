...
const ShowAllFollowing = () => {
    const followersData = JSON.parse(localStorage.getItem('blogUser'))?.user.following;
    ...
    return (
      <>
       ...
       {followersData.length ==0 && <div className='text-center w-full text-xl font-bold border-2 flex flex-row justify-center items-center border-gray-300 bg-white  m-1 h-32'> You are not follow anyone. 😟 </div> }
