...
const FirstDoLoginPopUp = ({setAllowedPopUp}) => {
    ...
    const handleBtnClick = (e)=>{
       ...
       setOpen(false);
       setAllowedPopUp(false);
      //  setCommentAllowedPopUp(false);
      //   setPostSavedAllowedPopUpHome(false)
                ...
                <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start">
                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      Create an account or login to write a response.
                      </Dialog.Title>
...
export default FirstDoLoginPopUp;
//CommentPopUp